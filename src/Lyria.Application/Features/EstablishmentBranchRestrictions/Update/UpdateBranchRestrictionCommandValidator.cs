...
public sealed class UpdateBranchRestrictionCommandValidator
    : AbstractValidator<UpdateBranchRestrictionCommand>
{
    public UpdateBranchRestrictionCommandValidator()
    {
