...
public sealed class CreateEstablishmentBranchCommandValidator
    : AbstractValidator<CreateEstablishmentBranchCommand>
{
    public CreateEstablishmentBranchCommandValidator()
    {
